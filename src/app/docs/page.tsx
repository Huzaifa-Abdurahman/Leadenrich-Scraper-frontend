          ...
          <div className="p-8 rounded-[2rem] bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 group hover:border-cyan-500/20 transition-colors">
            <div className="flex items-center gap-6">
               ...
               <div>
                  ...
                  <p className="text-xs text-slate-400 uppercase tracking-widest font-black">Building the Future of AI Software</p>
               </div>
            </div>
            <Link href="https://www.huzaifa.pro" target="_blank" className="px-8 py-3 bg-cyan-500 text-white text-xs font-black uppercase tracking-widest rounded-xl hover:bg-cyan-400 transition-colors shadow-lg shadow-cyan-500/20">
               Partner with Us
            </Link>
          </div>
        </section>
