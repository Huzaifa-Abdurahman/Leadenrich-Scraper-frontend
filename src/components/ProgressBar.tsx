...
export default function ProgressBar({ jobId, onProgress, onComplete }: ProgressBarProps) {
  ...
  if (!status) return (
     <div className="flex flex-col items-center gap-4 py-8 animate-pulse">
       ...
       <div className="text-xs font-black uppercase tracking-widest text-slate-300">Starting your search...</div>
     </div>
  );
         ...
         <div className="glass-card p-4 rounded-2xl flex items-center gap-4 border-white/5">
            ...
            <div className="text-left">
               ...
               <div className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">
                 {status.errors > 0 ? `${status.completed} found / ${status.errors} no data` : 'Websites checked'}
               </div>
            </div>
         </div>
        <div className="glass-card p-4 rounded-2xl flex items-center gap-4 border-white/5">
           ...
           <div className="text-left">
              ...
              <div className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">Companies with contacts</div>
           </div>
        </div>
      </div>
